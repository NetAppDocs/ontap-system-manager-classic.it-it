...
+
image::../media/vserver_service_iscsi_running_iscsi_windows.gif[L'illustrazione mostra la pagina del protocollo iSCSI con un'icona verde e il testo iSCSI service is running (Servizio iSCSI in esecuzione).]
